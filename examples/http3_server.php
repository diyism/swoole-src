 ...
 *
 * This demonstrates the HTTP/3 integration implemented in Phase 6.
 * Uses standard Swoole\HTTP\Server with HTTP/3 enabled.
 */

echo "==============================================\n";
echo "Swoole HTTP/3 Server\n";
echo "==============================================\n\n";
...
$server->on('Request', function (Swoole\Http\Request $request, Swoole\Http\Response $response) {
    ...
    $response->header('X-Server', 'Swoole-HTTP3');
    ...
    $body = "Hello from Swoole HTTP/3!\n\n";
    $body .= "Protocol: {$protocol}\n";
    $body .= "Method: {$method}\n";
    $body .= "URI: {$uri}\n";
    $body .= "\nHTTP/3 support: Complete request/response cycle ✅\n";
